...
PointLight::PointLight(const Point3f& location)
  : Light(), location_(location), color_(WHITE), light_scale_(static_cast<Float>(1.0))
{}
...
PointLight::PointLight(const Point3f& location,
  ...
  : Light(), location_(location), color_(color), light_scale_(ligth_scale)
{}
...
Color PointLight::light(const ShadeRecord& shade_rec) const
{
